...
namespace ExampleMod.Content.Projectiles
{
	public class YoyoProjectile : ModProjectile
	{
		...
		public YoyoProjectile(float maxRange, float topSpeed,int dustID, float lifeTime = -1){
		...
		public override void PostAI() {
			if (Main.rand.NextBool(5)) {
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, dustID); // Makes the projectile emit dust.
			}
		}
	}
}

...
namespace PhoenixCore.Projectiles
{
	...
	public class PiercingProjectile : ModProjectile
	{
	...
	internal class PiercingProjectileItem : ModItem
	{
		public string texture;
		public int piercingProjectileID;
		public PiercingProjectileItem(int piercingProjectileID, string texture){
			this.piercingProjectileID = piercingProjectileID;
		...
		public override void SetDefaults() {
			...
			Item.shoot = piercingProjectileID;
		}
	}
}

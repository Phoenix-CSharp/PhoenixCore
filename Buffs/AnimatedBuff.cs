...
namespace PhoenixCore.Buffs
{
	...
	public class AnimatedBuff : ModBuff
	{
		...
		public int FrameCount  { get; } // Amount of frames we have on our animation spritesheet.
		public int AnimationSpeed { get; } // In ticks.
		public string AnimationSheetPath { get; }
		public int DamageBonus {get;}
		public AnimatedBuff(int FrameCount, int AnimationSpeed, string AnimationSheetPath, int DamageBonus){
